...
class BrevWooAdmin
{
  ...
  public function add_settings_link($links)
  {
    ...
    $settings_link = "<a href=\"$url\">" . __('Settings', 'brevwoo') . '</a>';
  ...
  public function render_settings_page()
  {
    ?>
        <div class="wrap">
          ...
          <?php $this->render_brevo_connection_status(); ?>
  ...
  public function settings_page_init()
  {
    ...
    add_settings_field(
      ...
      [$this, 'render_api_key_input'], // callback
      'brevwoo-admin', // page
   ...
   */
  public function render_brevo_connection_status()
  {
  ...
  public function render_api_key_input($val)
  {
    ...
    printf(
      ...
      sprintf(
        __('Enter your Brevo API key. %s for more information.', 'brevwoo'),
   ...
   */
  public function add_brevwoo_panel()
  {
    add_meta_box(
      'brevwoo_options',
      __('BrevWoo', 'brevwoo'),
      [$this, 'brevwoo_panel_content'],
      'product',
   ...
   */
  function brevwoo_panel_content($post)
  {
   ...
   */
  public function process_wc_product_purchase($order_id)
  {
    ...
    foreach ($order->get_items() as $item) {
      ...
      if (!empty($brevo_list_id)) {
        $this->add_or_update_brevo_contact($order, [$brevo_list_id]);
      }
    }
  }
   ...
   */
  function add_or_update_brevo_contact($order, $listIds)
  {
    $brevo_api_key = get_option('brevwoo_brevo_api_key', '');
    ...
    if ($brevo_api_key) {
      ...
      try {
        ...
        error_log(
          'Error creating or updating Brevo contact: ' . $e->getMessage()
        );
      }
    }
  }
  ...
  public function enqueueStyles()
  {
    wp_enqueue_style(
      $this->plugin_name,
      plugin_dir_url(dirname(__FILE__)) . 'admin/css/brevwoo-admin.css',
      [],
      $this->version,
      'all'
    );
  ...
  public function enqueueScripts()
  {
    wp_enqueue_script(
      $this->plugin_name,
      plugin_dir_url(dirname(__FILE__)) . 'admin/js/brevwoo-admin.js',
      ['jquery'],
      $this->version,
      false
    );
